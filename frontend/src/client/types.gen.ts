...
export type Body_clients_get_client_proposal = {
...
export type ClientsGetClientProposalData = {
    formData: Body_clients_get_client_proposal;
};

export type ClientsGetClientProposalResponse = (ClientPublic);
