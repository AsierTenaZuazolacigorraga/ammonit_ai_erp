...
if TYPE_CHECKING:
    from ..models.prompt_public_structure_type_0 import PromptPublicStructureType0


T = TypeVar("T", bound="PromptPublic")
...
class PromptPublic:
    ...
    Attributes:
        ...
        structure (Union['PromptPublicStructureType0', None, Unset]):
    ...
    structure: Union["PromptPublicStructureType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.structure, Unset):
            structure = UNSET
        elif isinstance(self.structure, PromptPublicStructureType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_structure(data: object) -> Union["PromptPublicStructureType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                structure_type_0 = PromptPublicStructureType0.from_dict(data)

                return structure_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PromptPublicStructureType0", None, Unset], data)
        ...
        prompt_public.additional_properties = d
